...
if (isset($_POST["update"])) {
  ...
  $barangay = $_POST["Barangay"];
    ...
    if (empty($errors)) {
      // Construct SQL query to update records
      ...
      if ($stmt_update_users->affected_rows > 0 && $stmt_update_client_data->affected_rows > 0) {
