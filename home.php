...
if (isset($_POST["login"])) {
            ...
            $sql = "SELECT * FROM creates WHERE email = '$email' ";
        ...
        <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                <li class="nav-item d-flex flex-column" style="display: inline-flex; justify-content: center; align-items: right;">
                    <!-- Update the span to display the username -->
                     <!-- Display the username if set in the session -->
                     <span style="padding-right: 15px;" class="fs-4 fw-bold text-white">Welcome, <?php echo ucfirst($_SESSION['username']);?></span>
